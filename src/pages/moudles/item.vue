      ...
      <div class="service_box">
        ...
        >
          ...
          <span class="information_fase">
            ...
            >
              ...
              <span style="color: #ff4a53" v-if="item.teamService.balance === 0"
                >已到期</span
              >
              <span
                v-if="item.teamService.balance < 100"
            ...
            >
              ...
              <span v-if="item.teamService.endTime > currentTime">
                <span
                  style="color: #999"
                  v-if="item.teamService.remainDay !== 0"
                >
                  剩余
                  <span
        ...
        <span class="none">
          ...
          <ul class="ul_none">
            ...
            <li
              v-if="item.service.type !== 1 && item.service.type !== 4"
              @click="
                openDialog(
                  item.teamService.teamServiceId,
                  item.service.serviceId,
    ...
    >
      <div class="modal_dialog">
        <div class="modal_right">
          <p
            :class="{ state: dialogTitle === '秘钥管理' }"
            @click="stand('秘钥管理', 0)"
          >
            <span
              class="fl"
              :class="{ f1: dialogTitle === '秘钥管理' }"
              @click="stand('秘钥管理')"
            ></span>
          ...
          <p
            :class="{ state: dialogTitle === '成员管理' }"
            @click="stand('成员管理', 1)"
          >
            <span
              class="fl"
              :class="{ f1: dialogTitle === '成员管理' }"
              @click="stand('成员管理')"
            ></span>
            <i class="iconfont" style="padding-left: 20px">&#xe61c;</i
            >&nbsp;&nbsp; 成员管理
        ...
        <div
          class="modal_left"
          v-if="(nowIndex === 2) & (this.type !== 1) && this.type !== 4"
        >
          <setting-balance
    ...
    getUserServiceList(serviceCategory) {
      ...
      getUserServiceList(params)
        .then((res) => {
          ...
          console.log(this.serviceList,3333)
        })
        .catch((error) => {
          console.log(error);
        });
